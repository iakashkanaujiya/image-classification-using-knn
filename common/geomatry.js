// Adapted from original author: https://gist.github.com/id-ilych/8630fb273e5c5a0b64ca1dc080d68b63
...
geometry.area = (polygon) => {
    ...
    for (let i = 1; i < polygon.length - 1; i++) {
        ...
        area += geometry.triangelArea(A, B, C);
    };

    return area;
};

/** Calculate the side length of the polygon using Heron's formula*/
geometry.triangelArea = (A, B, C) => {
